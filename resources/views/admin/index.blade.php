...
<html class="x-admin-sm">
    <head>
        ...
        <!-- <link rel="stylesheet" href="{{url('css/theme5.css')}}"> -->
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="index.blade.php">X-admin v2.2</a></div>
            <div class="left_open">
        ...
        <div class="left-nav">
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="小说管理">&#xe6b4;</i>
                            <cite>小说</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('添加小说','/read/add')" target="">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加小说</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加轮播图','/read/turbot')" target="">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加轮播图</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加作品','/read/text')" target="">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加作品</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('作者列表','/read/author')" target="">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>作者列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('小说列表','/read/readindex')" target="">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>小说列表</cite></a>
                            </li>
